...
document.addEventListener('DOMContentLoaded', function() {
    new Typed('.home_title #subtitle', {
        strings: ["IT-xizmatlarini taqdim etish web-saytiga xush kelibsiz! Asosiy narsalarga e'tibor qarating va tartibni bizga ishonib topshiring! UZDEV.uz"],
        typeSpeed: 50,
        backSpeed: 20,
        smartBackspace: true,
        loop: true
    ...
    $('.popup-link').magnificPopup({
        ...
        image: {
            titleSrc: function(item) {
                return item.el.attr('title') + '<small>by UZDEV</small>';
            }
        }
    });	
